...
import org.howard.edu.hw5.IntegerSet.Listemptyexception;
...
class IntegerSetTest {	
	...
	void testClear() {
		my_set.add(1);
		my_set.clear();
		assertEquals(my_set.set_int.size(), 0);
	}	
	@Test
	...
	void testLargest() throws Listemptyexception {
		my_set.add(10);
		my_set.add(20);
		my_set.add(30);
		my_set.add(40);
	...
	void testLargestException() {
		assertThrows(Listemptyexception.class, () -> my_set.largest());
	}	
	@Test
	@DisplayName("Test case for smallest")
	void testSmallest() throws Listemptyexception {
		my_set.add(20);
		my_set.add(40);
		my_set.add(60);
		my_set.add(80);
	...
	void testSmallestException() {
		assertThrows(Listemptyexception.class, () -> my_set.smallest());
	}	
	@Test
	...
	void testUnion() {
		...
		assertEquals(my_set.set_int, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 4, 5, 6)));
	}
	@Test
	...
	void testIntersect() {
		...
		assertEquals(my_set.set_int, new ArrayList<Integer>(Arrays.asList(10, 20)));
	}	
	@Test
	...
	void testDifference() {
		...
		assertEquals(my_set.set_int, new ArrayList<Integer>(Arrays.asList(20, 60)));
	}
	@Test
